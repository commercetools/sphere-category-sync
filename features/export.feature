Feature: Export categories
  ...
  Scenario: Export works without template
    ...
    And the file "no-template.csv" should match /^id,key,externalId,parentId,orderHint,createdAt,lastModifiedAt,name.en,description.en,slug.en,metaTitle.en,metaDescription.en,metaKeywords.en/
