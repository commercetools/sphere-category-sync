...
1. Clone the repo with `git clone git@github.com:sphereio/sphere-category-sync.git`
2. Run `npm install`
...
5. To run all tests in watch mode, use `grunt watch:test`
6. Linting and static checks are done by `grunt lint`.
7. You can check the code coverage by running `grunt coverage`
...
## Commit message
Make sure your commit messages follow [Angular's commit message format](https://github.com/angular/angular.js/blob/master/CONTRIBUTING.md#-git-commit-guidelines). A sample commit message is given below:
